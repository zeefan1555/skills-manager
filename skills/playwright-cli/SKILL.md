...
```bash
# open the default persistent browser profile
playwright-cli -s=zeefan open --browser=chrome --profile="$HOME/.playwright-cli-profiles/zeefan"
# navigate to a page
...
```bash
playwright-cli -s=zeefan open https://example.com/form --browser=chrome --profile="$HOME/.playwright-cli-profiles/zeefan"
playwright-cli snapshot
