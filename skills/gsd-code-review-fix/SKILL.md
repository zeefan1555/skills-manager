...
<execution_context>
@$HOME/.trae/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @$HOME/.trae/get-shit-done/workflows/code-review-fix.md end-to-end.
