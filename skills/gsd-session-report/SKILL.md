...
<execution_context>
@$HOME/.trae/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @$HOME/.trae/get-shit-done/workflows/session-report.md end-to-end.
</process>
